...
def main(_):
  ...
  with tf.Session(graph=graph, config = tf.ConfigProto(intra_op_parallelism_threads=0, inter_op_parallelism_threads=0, \
                        allow_soft_placement=True, device_count = {'CPU': 12})) as sess:
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--image_dir',
      type=str,
      default='/tensorflow2/tf_files/images',
      help='Path to folders of labeled images.'
  )
  parser.add_argument(
      '--output_graph',
      type=str,
      default='/tensorflow2/tmp/output_graph.pb',
      help='Where to save the trained graph.'
  )
  parser.add_argument(
      '--intermediate_output_graphs_dir',
      type=str,
      default='/tensorflow/tmp/intermediate_graph/',
  ...
  parser.add_argument(
      '--output_labels',
      type=str,
      default='/tensorflow2/tmp/output_labels.txt',
      help='Where to save the trained graph\'s labels.'
  )
  parser.add_argument(
      '--summaries_dir',
      type=str,
      default='/tensorflow2/tmp/retrain_logs',
  ...
  parser.add_argument(
      '--model_dir',
      type=str,
      default='/tensorflow2/tmp/imagenet',
      help="""\
  ...
  parser.add_argument(
      '--bottleneck_dir',
      type=str,
      default='/tensorflow2/tmp/bottleneck',
